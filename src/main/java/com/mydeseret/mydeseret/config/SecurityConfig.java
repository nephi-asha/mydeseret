...
public class SecurityConfig {
    ...
    @Autowired
    private com.mydeseret.mydeseret.service.RateLimitingService rateLimitingService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAfter(new RateLimitFilter(rateLimitingService), JwtAuthenticationFilter.class)
