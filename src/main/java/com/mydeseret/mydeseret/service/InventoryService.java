...
public class InventoryService {
    ...
    @Transactional
    public StockMove adjustStock(Long item_id, int quantity_change, StockReason reason, String reference_id, String notes) {
        ...
        // A business can only request for it to be removed if they want to allow overselling
        if (newBalance < 0) {
